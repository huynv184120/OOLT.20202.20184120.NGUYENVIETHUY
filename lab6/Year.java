package lab6;
public class Year {
    private static String[] words1 = {"one", "two", "three", "four", "five", "six", "seven", "eigth", "nine"};
    private static String[] word2 = {"eleven", "twelve", "thirdteen", "fourteen", "fifteen", "sixteen", "seventeen",
    "eighteen", "nineteen"};
    private static String[] word3 = {"ten", "twenty", "thirty", "fourty", "fifty", "sixty", "seventy", "eighty", "ninety"};
